...
def main():
    ...
    input_dir = os.path.join(script_dir, "../external/datasets/random/tilt_shift/original")
    output_dir = os.path.join(script_dir, "../external/datasets/random/tilt_shift/blur")
